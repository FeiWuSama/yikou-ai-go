...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.EditTime = field.NewTime(tableName, "edit_time")
...
type user struct {
	...
	UserRole     field.String // 用户角色：user/admin
...
func (u *user) updateTableName(table string) *user {
	...
	u.EditTime = field.NewTime(table, "edit_time")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["edit_time"] = u.EditTime
