...
func newApp(db *gorm.DB, opts ...gen.DOOption) app {
	...
	_app.Priority = field.NewInt32(tableName, "priority")
	_app.UserID = field.NewInt64(tableName, "userId")
	_app.EditTime = field.NewTime(tableName, "editTime")
	_app.CreateTime = field.NewTime(tableName, "createTime")
	_app.UpdateTime = field.NewTime(tableName, "updateTime")
	_app.IsDelete = field.NewInt32(tableName, "isDelete")
...
func (a *app) updateTableName(table string) *app {
	...
	a.EditTime = field.NewTime(table, "editTime")
	a.CreateTime = field.NewTime(table, "createTime")
	a.UpdateTime = field.NewTime(table, "updateTime")
	a.IsDelete = field.NewInt32(table, "isDelete")
...
func (a *app) fillFieldMap() {
	...
	a.fieldMap["editTime"] = a.EditTime
	a.fieldMap["createTime"] = a.CreateTime
	a.fieldMap["updateTime"] = a.UpdateTime
	a.fieldMap["isDelete"] = a.IsDelete
}
