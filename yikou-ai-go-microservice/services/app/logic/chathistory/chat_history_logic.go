...
func (s *ChatHistoryService) ListAppChatHistoryByPage(ctx context.Context,
	...
	if app.UserID != loginUser.ID && loginUser.UserRole != string(commonenum.AdminRole) {
...
func (s *ChatHistoryService) generateSummary(ctx context.Context, appId int64, userId int64) {
	...
	// 调用 Agent 生成总结
	result, err := s.aiClient.SummarizeChat(ctx, &aiApi.SummarizeChatRequest{ChatHistory: chatHistoryBuilder.String()})
	if err != nil {
