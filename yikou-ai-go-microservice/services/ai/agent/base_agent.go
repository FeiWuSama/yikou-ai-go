...
import (
	...
	"fmt"
	"io"
	"yikou-ai-go-microservice/services/ai/agent/agentmiddleware"
...
func NewBaseAgent(chatModel ChatModelWrapperAdaptor, checkpoint *store.RedisStore, memoryStore store.MemoryStore) *BaseAgent {
